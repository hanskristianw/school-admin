# Graph Report - school-admin  (2026-08-07)

## Corpus Check
- 331 files · ~459,019 words
...
7. `Database Schema & Relationships` - 13 edges
...
Cohesion: 0.18
Nodes (11): browser-image-compression, class-variance-authority, clsx, googleapis, html5-qrcode, dependencies, browser-image-compression, class-variance-authority (+3 more)
...
## Knowledge Gaps
- **676 isolated node(s):** `extends`, `next/core-web-vitals`, `$schema`, `style`, `rsc` (+671 more)
...
- **Why does `School Admin System - Complete Documentation` connect `School Admin System - Complete Documentation` to `Module 128`, `🎯 **System Modules & Features**`, `🎓 **IB MYP Assessment Grading System**`, `📋 **Common Issues & Solutions**`, `🔐 **Role-Based Access Control**`, `📊 **Database Queries Reference**`, `🔧 **Technical Implementation**`, `📁 **Project Structure**`, `📌 Changelog`?**
