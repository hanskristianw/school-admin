...
## Corpus Check
- 389 files · ~647,404 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2231 nodes · 2305 edges · 370 communities (261 shown, 109 thin omitted)
...
- route.js
- route.js
- Panduan Pemasangan: Portal Registrasi Siswa Baru CCS di cPanel / Hosting (`ccs.sch.id`)
- graphify
- graphify.md
- bcryptjs
...
6. `generatePypClassReportPDF()` - 16 edges
...
10. `🎯 **System Modules & Features**` - 15 edges
...
## Communities (370 total, 109 thin omitted)
...
Cohesion: 0.12
Nodes (17): dotenv, driver.js, @fortawesome/fontawesome-svg-core, @fortawesome/free-solid-svg-icons, @hookform/resolvers, dependencies, dotenv, driver.js (+9 more)
...
- **Why does `dependencies` connect `Third-party Libraries` to `Admission Management`, `Package Dependencies & Config`, `Module 134`, `Module 136`, `Module 138`, `Module 139`, `Module 140`, `React UI Components`, `2026-07-16 — Timetable Refactor + Weekly Plan Dates + Weekly Overview`, `Module 144`, `Module 145`, `�🏗️ **Database Structure**`, `Module 148`, `bcryptjs`, `docx`, `Module 151`, `Module 152`, `🔧 **Technical Implementation**`, `Module 153`, `Module 154`, `**3. Assessment System**`, `Module 155`, `bcryptjs`, `googleapis`, `@googleapis/chat`, `react-hook-form`, `dotenv`, `pg`, `zod`, `bcryptjs`, `@sparticuz/chromium-min`, `SKILL.md`, `browser-image-compression`, `@google-cloud/vertexai`, `pngjs`?**
