...
## Corpus Check
- 312 files · ~396,098 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1548 nodes · 1492 edges · 353 communities (202 shown, 151 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad811b97`
...
- tailwind-merge
- enable-rls-examples.sql
- improved-fee-system.sql
- supabase-migration-uniform.sql
- create-admission-level.sql
- clean-slate-attendance.sql
- conservative-cleanup-attendance.sql
- create-student-applications.sql
- create-unit-approvers-and-excuses.sql
- **Key Components**
- redesign-fpb-role-approvers.sql
- supabase-migration-fees.sql
- route.js
- add-attendance-notification-system.sql
- add-fpb-budget-seller-url.sql
- add-year-dates.sql
- create-application-discount.sql
- create-application-installment.sql
- create-assessment-grading-system.sql
- create_settings_table.sql
- create-subject-group-criterion-descriptors.sql
- create-topic-weekly-plan.sql
- supabase-migration-qr-attendance.sql
- route.js
- add-reject-to-receipt-item.sql
- add-report-settings-cleanup-unit.sql
- create-attendances-webhook.sql
- create-leave-types-and-quotas.sql
- create-role-approvers.sql
- redesign-leave-quotas-nullable-user.sql
- remove-attachment-columns.sql
- simplify-fee-schema.sql
- update-myp-year-constraint.sql
- add-admission-extra-fields.sql
- add-approver-order-sequential.sql
- add-attachment-url-to-excuses.sql
- add-attendance-notify-run-log.sql
- add-criterion-descriptors-semester.sql
- add-detail-kelas-myp-year.sql
- add-expected-checkin-checkout-to-users.sql
- add-free-payment-method.sql
- add-is-part-time-staff-to-role.sql
- add-is-vendor-to-role.sql
- add-join-date-to-users.sql
- add-leave-default-days-and-menu-icons.sql
- add-menu-show-dashboard.sql
- add-note-to-uniform-sale.sql
- add-parent-nik.sql
- add-subject-core-and-print-order.sql
- add-subject-custom-grade-boundaries.sql
- add-subject-icon.sql
- add-subject-include-in-print.sql
...
## Communities (353 total, 151 thin omitted)
...
### Community 223 - "enable-rls-examples.sql"
Cohesion: 0.12
...
### Community 224 - "improved-fee-system.sql"
Cohesion: 0.24
...
### Community 225 - "supabase-migration-uniform.sql"
Cohesion: 0.37
...
### Community 226 - "create-admission-level.sql"
Cohesion: 0.29
...
### Community 230 - "create-unit-approvers-and-excuses.sql"
Cohesion: 0.47
...
- **Why does `🎯 **System Modules & Features**` connect `Community 149` to `School Admin System - Complete Documentation`?**
