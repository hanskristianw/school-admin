# Graph Report - school-admin  (2026-09-04)

## Corpus Check
- 369 files · ~601,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2147 nodes · 2214 edges · 357 communities (253 shown, 104 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b424ccd`
...
Cohesion: 0.07
Nodes (60): jspdf, jszip, jspdf, jszip, AdmissionManagement(), statusConfig, FeeSimulationPage(), formatCurrency() (+52 more)
