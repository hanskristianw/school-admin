...
Cohesion: 0.18
Nodes (11): bcryptjs, @fortawesome/react-fontawesome, googleapis, dependencies, bcryptjs, @fortawesome/react-fontawesome, googleapis, pdf-lib (+3 more)
...
## Knowledge Gaps
- **1132 isolated node(s):** `extends`, `next/core-web-vitals`, `$schema`, `style`, `rsc` (+1127 more)
